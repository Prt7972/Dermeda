      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-5 gap-10 md:gap-16 items-center">
          <div className="lg:col-span-2 text-center lg:text-left">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 md:mb-6 uppercase tracking-tighter leading-none font-header">Clinical AI <br/><span className="text-[#004fa3]">Specialist</span></h2>
