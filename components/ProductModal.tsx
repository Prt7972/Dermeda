...
const ProductModal: React.FC<ProductModalProps> = ({ product, onClose, onQuote }) => {
  return (
    <div className="fixed inset-0 z-[200] flex items-end md:items-center justify-center p-0 md:p-4 lg:p-8">
      ...
      <div className="relative w-full max-w-5xl bg-white rounded-t-[2rem] md:rounded-[2.5rem] shadow-2xl overflow-hidden animate-slide-up flex flex-col h-[85vh] md:h-auto md:max-h-[95vh]">
        <div className="bg-[#004fa3] p-5 md:p-10 text-white flex justify-between items-start sticky top-0 z-10 shrink-0">
          <div className="max-w-[80%] md:max-w-2xl">
            <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
              <span className="px-2 py-0.5 md:py-1 bg-white/20 rounded text-[9px] md:text-xs font-black uppercase tracking-widest border border-white/30">TDS Sheet</span>
        ...
        <div className="flex-grow overflow-y-auto p-5 md:p-12 space-y-8 md:space-y-10">
          <div className="grid md:grid-cols-12 gap-8 md:gap-16">
            <div className="md:col-span-5 lg:col-span-4">
               <div className="aspect-[4/5] md:aspect-square lg:aspect-[4/5] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden bg-slate-100 border border-slate-100 mb-6 md:mb-8 shadow-inner">
            ...
            <div className="md:col-span-7 lg:col-span-8 space-y-8 md:space-y-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-10">
                ...
                <div className="space-y-6 md:space-y-8">
                  <div>
                    <h4 className="text-[11px] md:text-base font-black uppercase tracking-[0.2em] text-[#f58220] mb-4 md:mb-6 border-b border-slate-100 pb-2 md:pb-3 font-header">Durability</h4>
                    <div className="grid gap-y-4 md:gap-y-6">
              ...
              <div>
                <h4 className="text-[11px] md:text-base font-black uppercase tracking-[0.2em] text-[#f58220] mb-4 md:mb-6 border-b border-slate-100 pb-2 md:pb-3 font-header">Certifications</h4>
              ...
              <div className="p-6 md:p-8 bg-slate-50 rounded-[1.5rem] md:rounded-[2rem] border border-slate-100">
                <h4 className="text-[10px] md:text-xs font-black uppercase tracking-widest text-slate-400 mb-2 md:mb-3">Clinical Applications</h4>
        ...
        <div className="p-5 md:p-10 bg-slate-50 border-t border-slate-200 flex flex-col sm:flex-row gap-3 md:gap-4 justify-between items-center sticky bottom-0 z-10 shrink-0">
